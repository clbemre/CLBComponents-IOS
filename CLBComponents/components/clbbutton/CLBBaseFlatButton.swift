...
@IBDesignable
public class CLBBaseFlatButton: UIButton
{
    ...
    @IBInspectable public var rippleLayerColor: UIColor = UIColor(hexString: "#CFCECE")! {
        didSet {
            clbLayer.setRippleColor(color: rippleLayerColor, withRippleAlpha: 0.05, withBackgroundAlpha: 0.05)
        }
    }
